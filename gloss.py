...
def search(term):
    ...
    result = {key: value for key, value in glossary.items() if term.lower() in key.lower()}
    if not result:
...
def list(category):
    ...
    categories = {
        ...
        "commit": ["feat", "fix", "docs", "style", "refactor", "perf", "test", "chore", "improvement", "build", "ci", "revert"],
        "HTTP": ["200", "201", "202", "204", "301", "302", "304", "400", "401", "403", "404", "405", "500", "501", "502", "503", "504", "505", "506", "507", "508", "510", "511"],
        "errors": ["SyntaxError", "TypeError", "ReferenceError", "RangeError", "IOError", "TimeoutError"],
